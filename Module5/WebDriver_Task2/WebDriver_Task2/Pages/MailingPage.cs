...
namespace WebDriver_Task2.Pages
{
    public class MailingPage : BasePage
    {
        ...
        public void WriteNewMail()
        {
            ...
            System.Threading.Thread.Sleep(5000);
            AdresseeField.SendKeys(TestData.TestData.EmailAddress);
            SubjectField.Clear();
            SubjectField.SendKeys(TestData.TestData.EmailSubject);       
            driver.SwitchTo().Frame(ElementItemFrame);
            BodyField.Clear();
            BodyField.SendKeys(TestData.TestData.EmailText);
