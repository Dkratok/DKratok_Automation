...
namespace Module6_2.Tests
{
    ...
    {
        PagesFactory.MailingPage mailingpage;
        ...
        public void IsSavedasDraft()
        {
            ...
            {
                loginpage.OpenPage();
                mailingpage = loginpage.Login((System.Configuration.ConfigurationSettings.AppSettings["UserName"]), (System.Configuration.ConfigurationSettings.AppSettings["Password"]));
            }
